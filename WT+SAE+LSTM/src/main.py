...
def test():
    runner = Runner('ford_ts.csv', hidden_layers_sizes=[6], last_dayes=200, debug=True)
...
class Runner:
    def __init__(self, ts_file_name,
                 ...
                 last_dayes=-1,
                 debug=False):
        self.data_loader = DataLoader(ts_file_name, last_dayes)
    ...
    def train(self, epoch=50):
        dataset = self.data_loader.prepare_dataset_sae(self.ts_data, self.time_frame,
                                                       self.time_bias)
